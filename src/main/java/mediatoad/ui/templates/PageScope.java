package mediatoad.ui.templates;
...
public class PageScope {
	...
	public final boolean openid_enabled;
	...
	public PageScope(
			...
			final boolean openid_enabled,
			final boolean db_enabled,
			final String query,
			final boolean allow_remote_search) {
